    ...
    return (
      <div className="flex h-full items-center justify-center bg-[#faf8f5]">
        <div className="flex flex-col items-center gap-4 text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-stone-200/70 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.02),0_8px_24px_-12px_rgba(0,0,0,0.08)]">
            <FaComment size={14} className="text-stone-300" />
          </div>

          <div>
            <p className="font-serif text-[15px] font-medium text-stone-700">
      ...
      <div className="px-8 pt-7 pb-6">
        <div className="relative overflow-hidden rounded-2xl border border-stone-200/70 bg-white shadow-[0_1px_2px_rgba(0,0,0,0.02),0_8px_24px_-12px_rgba(0,0,0,0.08)]">
          ...
          <div className="p-7">
            ...
            {/* TITLE */}
            <h2 className="font-serif text-[24px] font-medium text-stone-900 leading-[1.2] tracking-tight">
              {selected.title}
            </h2>
